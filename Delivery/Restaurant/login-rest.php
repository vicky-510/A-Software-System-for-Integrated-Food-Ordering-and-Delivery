...
<div class="container">
  ...
  <div class="brand-title">Restaurant Delivery Login</div>
<?php 
...
<br>
  <a href="<?php echo SITEURL;?>Delivery/Restaurant/register-delivery.php">Don't have an account? Signup</a>
...
<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql = "SELECT * FROM delivery_rest WHERE username='$username' AND pwd='$pwd'";
        ...
        if($count==1)
        {
            ...
            $_SESSION['delivery_rest'] = $username ; //TO check whether the user is logged in or not and logout will unset it
