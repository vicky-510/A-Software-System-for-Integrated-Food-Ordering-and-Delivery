...
<body>
    ...
    <!-- Navbar Section Ends Here -->
     ...
     <section class="food-search text-center">
        <div class="container">
           <h2 style="color: #182C61;">Delivery Boy Registration for Home service<br><br> 
</h2>
...
//get the value from category form
   ...
   $sql2 = "INSERT INTO delivery_home SET 
            username = '$username',
            pwd = '$pwd',
   ...
   if($res2 = true)
   {
       ...
       header("location:".SITEURL.'Delivery/Home-made/register-delivery.php');
