<?php
    ...
    $id = $_GET['id'];
     ...
     $sql = "DELETE FROM food_home WHERE id=$id";
    ...
    //query executed successfully and admin deleted 
     ...
     $_SESSION['delete'] = "<div class='success'>Food deleted successfully   <strong>X</strong></div>";
    ...
    //query failed to execute and delete admin  
       ...
       $_SESSION['delete'] = "<div class='error'>Failed to  delete food. try again later!   <strong>X</strong></div>";
