...
<br>
	...
	<a href="manage-category.php" style="margin-left:93px;">
...
<?php 
	 ...
	 if(isset($_POST['submit']))	 {
           ...
           if($upload==false){
            ...
            //create a session variable to display msg
	         ...
	         //redirect to manage admin
	          header("location:".SITEURL.'Back-end/Home-food/admin/add-category.php');
		...
		//create a sql to insert category into database
		      $sql="INSERT INTO category_home SET 
		  ...
		  if($res==true){
			...
			//query execute and category added
			 //echo "inserted";
	        //create a session variable to display msg
	        $_SESSION['add'] = "<div class='success'>Category Added Successfully   <strong>X</strong></div>";
             ...
             //echo "not inserted";
	         //create a session variable to display msg
	         $_SESSION['add'] = "<div class='error'>Failed to  Add Category    <strong>X</strong></div>";
