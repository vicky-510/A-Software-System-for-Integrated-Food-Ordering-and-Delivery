...
<div class="wrapper">
   ...
   <div class="main-content ">
    ...
    <!-- Button to add admin-->
                  <a href="<?php echo SITEURL; ?>Back-end/Home-food/admin/add-food.php" class="btn-primary-f"> Add Food</a>
                  </br>
                  </br>
                            ...
                            if($count>0){
                               ...
                               while($rows=mysqli_fetch_assoc($res)){
                                ...
                                <tr>
                                   ...
                                   <td>
                                    ...
                                    if($image_name!="")
                                    {
                                       ...
                                       ?>
                                          ...
                                          <img src="<?php echo SITEURL; ?>Front-end/img/food/<?php echo $image_name?>" width="100px" style="margin-right:5px">
                                 ...
                                 <td>
                                         <span><?php echo "<div class='f-details1'>Home Chef name: ".$home_name.",</div>"; ?></span><br>
                                         <span><?php echo "<div class='f-details2'>Home Chef address :<br><br> ".$home_address."</div>"; ?><span><br>
                                          <span><?php echo "<div class='f-details3'>Home Chef district : ".$home_district."</div>"; ?></span><br>
                                          <span><?php echo "<div class='f-4'>Home Chef Mobile number : ".$home_number.".</div>"; ?></span><br>
                                   ...
                                   <td>
                                    <a href="<?php echo SITEURL; ?>Back-end/Home-food/admin/update-food.php?id=<?php echo $id; ?>" class="btn-secondary1" style="margin-left:10px;">Update Food</a>
                                        <br>
                                        <br>
                                    <a href="<?php echo SITEURL; ?>Back-end/Home-food/admin/delete-food.php?id=<?php echo $id; ?>" class="btn-danger1" style="margin-left:10px;">  
                                    Delete Food</a>
                                   </td>
                                   </tr>
