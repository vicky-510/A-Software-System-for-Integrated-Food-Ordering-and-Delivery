...
<div class="login-box">
  ...
  <br>
       ...
       <?php
          ...
          $sql = "SELECT * FROM category_home WHERE id=$id";
...
if($current_image !=""){
  ...
  ?>
  <img src="<?php echo SITEURL; ?>Front-end/img/category/<?php echo $current_image?>" width="150px">
  <?php
}
else{
...
<br>
<br>
    <input type="file" name="image" value="<img src='<?php echo SITEURL; ?>Front-end/img/category/<?php echo $current_image?>'>" required="">
...
<a href="<?php echo SITEURL; ?>Back-end/Home-food/admin/manage-category.php" style="margin-left:93px;">
	 ...
	 if(isset($_POST['submit']))	 {
        ...
        if(isset($_FILES['image']['name']))
        {
          ...
          //to upload image and set the image_name,source path and destination path
           ...
           $destination_path ="../../../Front-end/img/category/".$image_name;
