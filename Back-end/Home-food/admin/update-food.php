...
<div class="login-box">
  ...
  <br>
       ...
       <?php
          ...
          $sql = "SELECT * FROM food_home WHERE id=$id";
          ...
          if($res==true)
          {
            ...
            if($count==1){
                ...
                $home_name=$row['rest_name'];
                $home_address=$row['rest_address'];
                $home_district=$row['rest_district'];
                $home_number=$row['rest_number'];
                $price=$row['price'];
...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <br>
  <div class="user-box">
    <input type="text" name="rest_name" required=""value="<?php echo $home_name; ?>" >
    <label>Restaurant name</label>
  </div>
  <div class="user-box">
    <input type="text" name="rest_address" required="" value="<?php echo $home_address; ?>">
    <label>Restaurant address</label>
  </div>
  <div class="user-box">
    <input type="text" name="rest_district" required="" value="<?php echo $home_district; ?>">
    <label>Restaurant district</label>
    <div class="user-box">
    <input type="number" name="rest_number" required="" value="<?php echo $home_number; ?>">
...
if($current_image !=""){
  ...
  ?>
  <img src="<?php echo SITEURL; ?>Front-end/img/food/<?php echo $current_image?>" width="150px">
  <?php
}
else{
...
<br>
<br>
    <input type="file" name="image" value="<img src='<?php echo SITEURL; ?>Front-end/img/food/<?php echo $current_image?>'>" required="">
...
<br>
    <select type="number" name="category" required="">
       ...
       <?php
           ...
           $sql1 = "SELECT * FROM category_home WHERE active='Yes' ";
...
<input type="hidden" name="current_image" value="<?php echo $current_image; ?>">
  ...
  <a href="<?php echo SITEURL; ?>Back-end/Home-food/admin/manage-food.php" style="margin-left:93px;">
