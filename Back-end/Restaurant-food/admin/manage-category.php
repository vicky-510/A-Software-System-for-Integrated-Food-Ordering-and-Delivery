...
<div class="wrapper">
   ...
   <div class="main-content ">
    ...
    <br/>
                 ...
                 <!-- Button to add admin-->
                  <a href="<?php echo SITEURL; ?>Back-end/Restaurant-food/admin/add-category.php" class="btn-primary2"> Add Category</a>
                  </br>
                  </br>
                            ...
                            if($res==TRUE)
                            {
                             ...
                             if($count>0){
                                ...
                                <tr>
                                   ...
                                   <td>
                                    ...
                                    if($image_name!="")
                                    {
                                       ...
                                       ?>
                                          ...
                                          <img src="<?php echo SITEURL; ?>Front-end/images/category/<?php echo $image_name?>" width="150px" style="margin-right:60px">
                                   ...
                                   <td>
                                    <a href="<?php echo SITEURL; ?>Back-end/Restaurant-food/admin/update-category.php?id=<?php echo $id; ?>" class="btn-secondary1">  Update Category</a>
                                    <br>
                                    <br><br>
                                    <a href="<?php echo SITEURL; ?>Back-end/Restaurant-food/admin/delete-category.php?id=<?php echo $id; ?>" class="btn-danger1">  Delete Category</a>
                                   </td>
                                   </tr>
