...
<div class="container">
  ...
  <div class="brand-title">Restaurant Admin</div>
<?php 
...
<form action="" method="POST" >
  ...
  <a href="<?php echo SITEURL;?>Back-end/Home-food/admin/login-home.php">Home Made Admin Login?</a>
...
<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql = "SELECT * FROM admin_rest WHERE username='$username' AND pwd='$pwd'";
        ...
        if($count==1)
        {
            ...
            header('location:'.SITEURL.'Back-end/Restaurant-food/admin/index.php');
        }
        else
        {
