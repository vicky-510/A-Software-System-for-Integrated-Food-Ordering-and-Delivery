    ...
    <!-- Navbar Section Ends Here -->
     ...
     <section class="food-search6 text-center">
        ...
        ?>
            ...
            <h2>Recipie on Your Search <a href="#" class="text-white">"<?php echo $recipies1; ?>"</a></h2>
...
?> <br>
  ...
  <ul class="cards">
        ...
        <?php
           ...
           $sql2 ="SELECT * FROM recipies_tamil WHERE title LIKE '%$recipies1%' OR description LIKE '%$recipies1%' ";
