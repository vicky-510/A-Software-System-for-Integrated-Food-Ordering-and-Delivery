    ...
    <!-- Navbar Section Ends Here -->
     ...
     <section class="food-search6 text-center">
        ...
        <form action="<?php echo SITEURL; ?>Recipies-search.php" method="POST">
                ...
                <input type="search" name="recipies" placeholder="Search for Recipies in English.." required id="search-bar">
                <input type="submit" name="submit" value="Search" class="btn btn-primary" id="search-btn"><br><br>
                <span style="font-size:20px; font-weight:bold; color:navy;">Want to add your Recipies  <a href="<?php echo SITEURL; ?>Blog/add-recipies-eng.php" style="font-size:20px; font-weight:bold; color:green;">Click here</a><span><br><br>


            </form>
            <a href="<?php echo SITEURL; ?>Recipies-tam.php" style="font-size:20px; font-weight:bold; border:5px; padding:8px 16px; background-color: #182C61; color: white; "> See Recipies in Tamil </a>
