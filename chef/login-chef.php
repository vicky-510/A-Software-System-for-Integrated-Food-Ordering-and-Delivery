...
<div class="container">
  ...
  <div class="brand-title">Chef Login</div>
<?php 
...
<form action="" method="POST" >
  ...
  <a href="<?php echo SITEURL;?>chef/register-chef.php">Don't have an account? Signup</a>
...
<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql = "SELECT * FROM chef_hire WHERE username='$username' AND pwd='$pwd'";
        ...
        if($count==1)
        {
            ...
            $_SESSION['login-chef'] = "<div class='success'>Login Successful     <strong>X</Strong></div>";
            $_SESSION['user'] = $username ; //TO check whether the user is logged in or not and logout will unset it
            $_SESSION['user-id'] = $id ; //TO check whether the user is logged in or not and logout will unset it
        ...
        else
        {
            ...
            $_SESSION['login-chef'] = "<div class='error '>Username or Password did not match.    <strong>X</Strong></div>";
            //REdirect to HOme Page/Dashboard
