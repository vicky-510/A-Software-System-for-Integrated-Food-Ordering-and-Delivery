...
<body>
    ...
    <!-- Navbar Section Ends Here -->
     ...
     <section class="food-search text-center">
        <div class="container">
           <h2 style="color: #182C61;">Restaurant User Registration<br><br> 
</h2>
...
//get the value from category form
   ...
   $sql2 = "INSERT INTO user_rest SET 
            username = '$username',
            pwd = '$pwd',
            cust_name='$cust_name',
   ...
   if($res2 = true)
   {
       ...
       header("location:".SITEURL.'Front-end/food-types/Restaurant/register-user.php');
