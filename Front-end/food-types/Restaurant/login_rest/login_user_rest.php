...
<div class="container">
  ...
  <div class="brand-title">Restaurant User</div>
<?php 
...
<form action="" method="POST" >
  ...
  <a href="<?php echo SITEURL;?>Front-end/food-types/Restaurant/register-user.php">Don't have an Account? Signup</a>
...
<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql = "SELECT * FROM user_rest WHERE username='$username' AND pwd='$pwd'";
        ...
        if($count==1)
        {
            ...
            $_SESSION['user_rest'] = $username; //TO check whether the user is logged in or not and logout will unset it
