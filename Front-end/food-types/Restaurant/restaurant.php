        ...
        <div class="container">
            ...
            <div class="menu text-right">
                <ul>
                    ...
                    <li>
                    <a href="<?php echo SITEURL; ?>Front-end/food-types/Restaurant/restaurant.php"  style="color: orange;">Restaurants</a>
                    </li>
                    <li>
    ...
    <section class="food-menu">
       ...
       if(isset($_SESSION['check']))
       {
        ...
        unset($_SESSION['check']);//remove msg       
           ...
           $sql2 ="SELECT * FROM food_rest WHERE active='Yes' AND featured='Yes' ORDER BY id ASC LIMIT 6 ";
        ...
        <p class="text-center">
            <a href="<?php echo SITEURL; ?>Front-end/food-types/Restaurant/rest-foods.php" class="text-white">See All Foods</a>
        </p>
    </section>
    <!-- fOOD Menu Section Ends Here -->
      ...
      <section class="categories">
        <div class="container">
            ...
            $sql ="SELECT * FROM category_rest WHERE active='Yes' AND featured='Yes' ORDER BY title ASC  LIMIT 3";
            //execute the query
