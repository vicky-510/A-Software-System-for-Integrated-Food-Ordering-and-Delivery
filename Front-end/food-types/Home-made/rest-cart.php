        ...
        <div class="container">
            ...
            <div class="menu text-right">
                <ul>
                    ...
                    <li>
                    <a href="<?php echo SITEURL; ?>Front-end/food-types/Home-made/rest-cart.php" style="color: orange;">Orders</a>
                    </li>
       ...
       <div class="main-content1 ">
        ...
        <form action="" method="post" class="order1">
                        ...
                        <?php
                           ...
                           $sql = "SELECT * FROM basket_home WHERE user_id=$user_id ORDER BY id DESC";
                    ...
                    <span style="font-size:15px; font-weight:bold;">X</span> <br><br> 
                        ...
                        <span style="color:Navy; background-color:yellow; padding:4px 8px; ">Order ID: <?php echo $id;?></span><br><br>
                        <span style="color:white; background-color:violet; padding:4px 8px; border-radius:5px;">Ordered Date/Time: <?php echo $order_date;?></span><br><br>
                        <span >
    ...
    ?>
          ...
          <tr> <td> </td>
               ...
               <?php
                  ...
                  $sql3 = "SELECT SUM(total) As Total FROM basket_home WHERE user_id=$user_id ";
                  ...
                  ?>
               <td><span style="color:orange; font-weight: bold;"> Total Price:<?php echo " ".$total_cost;?></span>
              </td>

              <td>
               <span>You will receive your order within 20-30 mins based on location.</sapn>
              </td>
    </tr>
