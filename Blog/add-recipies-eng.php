        ...
        <div class="container ">
                 ...
                 <div class="food-type-box3 ">
                    ...
                    <div class="" style="color: black;  border-radius: 5px; ">
                        ...
                        <label style="color: rgb(255, 255, 255); border-radius: 5px; margin-right:70px; color: navy; margin-left:35px; font-weight:bold;  ">Upload image (376 x 250) :</label><br><br>
...
//get the value from category form
   ...
   $sql2 = "INSERT INTO recipies_eng SET 
            title = '$title',
   ...
   if($res2 == true)
   {
       ...
       $_SESSION['add'] = "<div class='success'>Recipie Added Successfully  <strong>X</strong></div>";
   ...
   else
   {
       ...
       //query not executed 
       $_SESSION['add'] = "<div class='error'>failed to Recipie   <strong>X</strong></div>";
       header("location:".SITEURL.'Blog/add-recipies-eng.php');
