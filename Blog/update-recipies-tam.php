...
<body>
    ...
    <!-- Navbar Section Ends Here -->
     ...
     <section class="food-search6 text-center">
        <div class="container">
           <h2 style="color: #182C61;">உங்கள் சமையல் குறிப்புகளை ஆங்கிலத்தில் பதிவிடவும்
           <br><br>
    ...
    <?php
          ...
          $sql = "SELECT * FROM recipies_tamil WHERE id=$id";
          ...
          if($res==true)
          {
            ...
            if($count==1){
              ...
              $_SESSION['no-category-found'] = "<div class='error'>வகை எதுவும் இல்லை    <strong>X</strong></div>";
        ...
        <div class="container ">
                 ...
                 <div class="food-type-box3 ">
                    ...
                    <div class="" style="color: black;  border-radius: 5px; ">
                        ...
                        <h4 id="head" class="text-center" style="color: rgb(255, 255, 255);  background-color:  rgb(255, 0, 81); height: 30px; padding:8px;"> உங்கள் சமையல் குறிப்புகளைச் சேர்க்கவும்</h4>
                        <br>  
                        ...
                        <label style="color: rgb(255, 255, 255); border-radius: 5px; margin-right:70px; color: navy; margin-left:35px; font-weight:bold;  ">தற்போதைய படம் :</label><br><br>
                      ...
                      if($current_image !=""){
                        ...
                        ?>
                        <img src="<?php echo SITEURL; ?>Front-end/blog/tam/<?php echo $current_image?>" width="150px" style="margin-left:50px;">
                        <?php 
                       }
                       else{
                      ...
                      ?><br><br>
                        <label style="color: rgb(255, 255, 255); border-radius: 5px; margin-right:70px; color: navy; margin-left:35px; font-weight:bold;  ">புதிய படம் (376 x 250) :</label><br><br>
...
//get the value from category form
          ...
          if($image_name !=""){
           ...
           if($upload==false){
            ...
            //create a session variable to display msg
	         $_SESSION['upload'] = "<div class='error'>புகை படத்தை பதிவேற்ற முடியவில்லை    <strong>X</strong></div>";
   ...
   $sql2 = "UPDATE recipies_tamil SET 
            title = '$title',
   ...
   if($res2 == true)
   {
       ...
       $_SESSION['update'] = "<div class='success'>ரெசிபி வெற்றிகரமாக புதுப்பிக்கப்பட்டது  <strong>X</strong></div>";
       header("location:".SITEURL.'Recipies-tam.php');
   ...
   else
   {
       ...
       //query not executed 
       $_SESSION['update'] = "<div class='error'>ரெசிபியைப் புதுப்பிக்க முடியவில்லை       <strong>X</strong></div>";
       header("location:".SITEURL.'Blog/add-recipies-tam.php');
